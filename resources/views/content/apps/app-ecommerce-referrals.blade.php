                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column flex-sm-row justify-content-between text-center gap-3">
                        <div class="d-flex flex-column align-items-center">
                            <span><i
                                    class='ti ti-rocket text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0'></i></span>
                            <small class="my-2 w-75">Create & validate your referral link and get</small>
                            <h5 class="text-primary mb-0">$50</h5>
                        </div>
                        <div class="d-flex flex-column align-items-center">
                            <span><i
                                    class='ti ti-id text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0'></i></span>
                            <small class="my-2 w-75">For every new signup you get</small>
                            <h5 class="text-primary mb-0">10%</h5>
                        </div>
                        <div class="d-flex flex-column align-items-center">
                            <span><i
                                    class='ti ti-send text-primary ti-xl p-3 border border-1 border-primary rounded-circle border-dashed mb-0'></i></span>
                    ...
                    <form class="referral-form" onsubmit="return false">
                        <div class="mb-4 mt-1">
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-end">
                                <div class="w-75">
                                    <label class="form-label mb-0" for="referralEmail">Enter friend’s email address and
                                        invite them</label>
                                    <input type="text" id="referralEmail" name="referralEmail" class="form-control w-100"
                        ...
                        <div>
                            ...
                            <div class="d-flex flex-wrap gap-3 align-items-end">
                                <div class="w-75">
                                    <label class="form-label mb-0" for="referralLink">Share referral link in social
                                        media</label>
                                    <input type="text" id="referralLink" name="referralLink"
                                        class="form-control w-100 h-px-40" placeholder="" />
                                </div>
                                <div>
                                    <button type="button" class="btn btn-facebook btn-icon me-2"><i
                                            class='ti ti-brand-facebook text-white ti-sm'></i></button>
                                    <button type="button" class="btn btn-twitter btn-icon"><i
                                            class='ti ti-brand-twitter text-white ti-sm'></i></button>
                                </div>
                            </div>
                        </div>
                    </form>
