                    ...
                    <div id="" class=" col-md-6">
                        <a href="#idols">
                            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                                <img src="{{ asset('assets/img/front-pages/landing-page/lord-ganesh-front.png') }}"
                                    alt="hero dashboard" class="animation-img w-100"
                                    data-app-light-img="front-pages/landing-page/lord-ganesh-front.png"
                                    data-app-dark-img="front-pages/landing-page/lord-ganesh-front.png" />
        ...
        <section id="idols" class="section-py landing-team">
            <div class="container">
                <div class="text-center mb-3 pb-1">
                    <span class="badge bg-label-primary">Best Seller</span>
                </div>
                <h3 class="text-center mb-1"><span class="section-title">Ganesh Idols</h3>
                <p class="text-center mb-md-5 pb-3">Embrace tradition.</span>
                    Timeless
                    clay idols: crafted artistry, cultural elegance.</p>
            ...
            <div class="container mt-4">
                ...
                <h3 class="text-center mb-1"><span class="section-title">Ammavaru Idols</span> </h3>
                <p class="text-center mb-md-5 pb-3">Step into tradition with these <span class="section-title">9
                        Feet</span> clay idols, a timeless nod to our cultural heritage.</p>
                <div class="row gy-5 mt-2">
                    <div class="col-lg-4 col-sm-6 mt-5 mb-4">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-primary position-relative team-image-box">
