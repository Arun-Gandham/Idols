...
@section('title', isset($pageSettings['title']) ? $pageSettings['title'] : "Product Type List")
...
@section('content')
    ...
    <div class="d-flex justify-content-between">
        <h4 class="py-3 mb-3">
            <span class="text-muted fw-light">Product Type/</span> List
        </h4>
        <a href="{{ route('type.add') }}"><button class="btn btn-primary mt-2" style="padding: 15px;height: 30px;"><i
